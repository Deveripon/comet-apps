                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="bottom"
                                        title="edit" href="{{route('product-tag.edit',$item -> id)}}"><i
                                            class="fa-solid fa-pen-to-square"></i></a>


                                    <form action="{{route('product-tag.destroy',$item -> id)}}" method="POST"
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-header justify-content-between d-flex">
                ...
                <a class="text-info btn btn-outline-info" href="{{route('product-tag.index')}}">Back</a>
            </div>
            <div class="card-body">
                @include('validate')
                <form action="{{route('product-tag.update',$tags_id -> id)}}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
