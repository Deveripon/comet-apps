                            ...
                            <tr>
                                ...
                                <td>
                                    <img style="width:80px; height:80px;"
                                        src="{{url('storage/portfolio_img/featured_img/'.$item-> featured_img)}}"
                                        alt="">
                                </td>
                                <td>
                                    <ul>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info" href="{{route('home.page')}}"><i
                                            class="fa-solid fa-eye"></i></a>

                                    <a class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="bottom"
                                        title="edit" href="{{route('portfolio.edit',$item -> id)}}"><i
                ...
                <form action="{{route('portfolio.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <ul style="margin-left:-35px">
                        ...
                        <li style="list-style:none;">
                            <input type="checkbox" name="p_category[]" value="{{$item -> id}}"
                                id="{{$item -> id}}"><label for="{{$item -> id}}">{{$item -> title}}</label>
                        </li>
                        @endforeach
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card shadow-sm step_accordion">
                            <div class="card-header" id="headingOne">
                                <h6 style="cursor: pointer;" class="mb-0" data-toggle="collapse"
                            ...
                            <div id="collapseOne" class="collapse" data-parent="#accordionExample">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <div class="desc">
                                        <textarea placeholder="Description" class="form-control" name="step_desc[]"
